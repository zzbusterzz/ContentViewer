...
public enum _3DMethod { None, Interleaved, SideBySide, OverUnder, Anaglyph };

public class Stereo3D : MonoBehaviour
{
    public static Stereo3D instance;
    ...
    public _3DMethod method = _3DMethod.Interleaved; //Stereo3D output method
	    ...
	    GUILayout.BeginHorizontal();
		    GUILayout.BeginVertical();
			    ...
			    GUILayout.EndHorizontal();
				    ...
				    method = (_3DMethod)GUILayout.SelectionGrid((int)method, modeStrings, 1, GUILayout.Width(100));
